...
//    @GetMapping("/user/{id}")
//    public ResponseEntity<UserSetting> getUserSettings(@PathVariable Integer id) {
...
//    @PostMapping("/user/{id}")
//    public ResponseEntity<UserSetting> updateUserSettings(@PathVariable Integer id, @RequestBody UserSetting userSetting) {
//        UserSetting updatedSetting = userSettingService.updateSettings(id, userSetting);
